...
| D | Phrase query (biword vs positional), false-positive demo |
...
5. Click **Load Project Dataset** or **Load Sample Dataset**, then walk through tabs A → G.

## Recommended Demo Flow

1. **Tab A** — Click **Load Project Dataset** (8 news documents) or **Load Sample Dataset**
...
4. **Tab D** — Click **Run False-Positive Demo** for `quick brown fox`
...
- Built-in sample — 18 documents including a biword false-positive demo document
